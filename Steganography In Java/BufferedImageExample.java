...
public class BufferedImageExample
{
	...
	public static void main(String[] args){
		...
		BufferedImageExample shi = new BufferedImageExample();
	...
	public boolean encode()
	{
		...
		BufferedImage 	image_orig	= getImage("aa.jpg");
	...
	public String decode(String path, String name)
	{
		...
		try
		{
			...
			JOptionPane.showMessageDialog(null, "Your message :  "+ new String(decode));
	 ...
	 *@see	BufferedImageExample.image_path
	 */
...
public class BufferedImageExample{
	...
	public static void main(String[] args){
		...
		try
		{
			...
			BufferedImage image  = new BufferedImage(oimage.getWidth(), oimage.getHeight(), BufferedImage.TYPE_3BYTE_BGR);
			Graphics2D	graphics = image.createGraphics();
			graphics.drawRenderedImage(oimage, null);//Making Space In User Memory For New Image Which Will Hide Text
			graphics.dispose();
		}
		catch(Exception ex)
		{
