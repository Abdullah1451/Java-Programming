...
"Target File cannot hold message!", "Error",JOptionPane.ERROR_MESSAGE);
	...
	public static void main(String[] args) {
		Steganography shi = new Steganography();
		shi.decode("C:/Users/Azmi/Pictures", "Spgi");
		//shi.encode("C:/Users/Azmi/Pictures", "stego" , "jpg", "Spgi", "abdullah is very good boy but he can bad when he wants so be careful");
	}
}
